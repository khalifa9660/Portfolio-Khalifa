  ...
  return (
    <footer className="py-8 px-6 md:px-12 border-t border-black/5 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500 dark:text-white/40 transition-colors duration-300">
      ...
      <div className="flex items-center gap-6">
        ...
        <a href="https://github.com/khalifa9660" target="_blank" rel="noreferrer" className="hover:text-gray-900 dark:hover:text-white transition-colors">GitHub</a>
        <a href="https://breyvio.com" target="_blank" rel="noreferrer" className="hover:text-gray-900 dark:hover:text-white transition-colors">Breyvio</a>
